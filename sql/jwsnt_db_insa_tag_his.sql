...
--
-- Table structure for table `insa_tag_his`
--

DROP TABLE IF EXISTS `insa_tag_his`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `insa_tag_his` (
  `tag_no` int(11) NOT NULL,
  `tag_use_no` int(11) NOT NULL,
  ...
  PRIMARY KEY (`tag_no`,`tag_use_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `insa_tag_his`
--

LOCK TABLES `insa_tag_his` WRITE;
/*!40000 ALTER TABLE `insa_tag_his` DISABLE KEYS */;
/*!40000 ALTER TABLE `insa_tag_his` ENABLE KEYS */;
UNLOCK TABLES;
